...
-   Include the Chief Operations Officer (COO) in all hiring, disciplining, and problem customer occurrences.
...
-   Follow and enforce the [Uniform Policy](/i/20).
...
-   Arrange their own CPR class once per year and send Human Resources copies of the newly updated cards.
...
GMs have an annual budget for their branch of $350 per employee for Employee Morale (food, fun events, team events, teambuilding, etc.) and $200 per employee for Professional Development.
...
GMs do not have the authority to change wood replacement prices on the contract. Any wood replacement contract changes must be approved by the COO. If the customer specifically asks for a wood replacement price change, the COO must approve the change.
...
GMs are required to bring sales estimate errors to the COO. The COO and the Sales Manager will then determine if the sales issue is due to gross negligence. In cases of careless bidding errors by sales staff the COO and Sales Manager may decide to deny sales commission for that job. In cases where the COO and the Sales Manager cannot come to an agreement, the issue will be brought to the weekly Executive meeting for discussion.

GMs should reach out to the COO directly to discuss and work through figuring out OP values for one off job oddities.
...
GMs are required use the [General Manager – Payroll Information](/i/166).

GMs are responsible to have payroll spreadsheets finished and submitted each Monday by 5:00pm. 

-   The COO will continue to do payroll spot checks with audits weekly by Friday COB but will no longer continue to check every job.
...
GMs are required to know and understand the [Job Progress Tutorials: All Positions](/i/61).

GMs must maintain the minimum required branch score per the [Guild Quality Policy](/i/36).

GMs must maintain a 4.9 Google review rating for their branch(es). If at any time, they fall below 4.9, they will be put on probation and have 6 months to get back to 4.9.

GMs are required to read the [Cenvar Roofing Book List](/i/155).
